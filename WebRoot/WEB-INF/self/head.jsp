...
-->
		...
		<div class="head">
			<img src="/xiaonei/images/front/top1.gif" width="713px" />
			<img src="/xiaonei/images/front/top2.jpg" width="280px" />
			<img src="/xiaonei/images/front/xnw3.jpg" style="float: left;" />
			<ul class="home_navi">
			<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)"><a class="top" href="/xiaonei/login.do?flag=logout">首页</a></li>
			<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)"><a class="top" href="/xiaonei/profile.do?flag=goHomePageUI">个人主页</a></li>
			...
			<li>搜索</li>
			<li style="width: 170px;"><input type="text" /><img src="/xiaonei/images/front/sou.jpg" /></li>
			</ul>
