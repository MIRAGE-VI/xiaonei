...
/**
 * AbstractTown entity provides the base persistence definition of the Town
 * entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTown implements java.io.Serializable {
	...
	/** minimal constructor */
	public AbstractTown(String name) {
		this.name = name;
	}

	/** full constructor */
	public AbstractTown(City city, String name, Set primaryschools,
			Set techschools, Set juniors, Set seniors) {
		this.city = city;
		this.name = name;
