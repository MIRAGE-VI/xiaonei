...
public abstract class AbstractUsers implements java.io.Serializable {
	...
	/** minimal constructor */
	public AbstractUsers(String email, String name, String pwd) {
		this.email = email;
		this.name = name;
		this.pwd = pwd;
	}
	...
	/** full constructor */
	public AbstractUsers(Techschool techschool, Junior junior,
			Province province, City city, Primaryschool primaryschool,
			String email, String name, String pwd, String photo, String sex,
			Date birth, String tel, String mobile, String oicq, String msn,
			String website, Integer techSchYear, Integer juniorYear,
			Integer primaryYear, String interest, String music, String movie,
